# code from DXSLAM: https://github.com/ivipsourcecode/dxslam
import time
...
if __name__ == "__main__":
    ...
    model_path = "/media/wanghao/1E461A75461A4E41/文件/CV/HF-Net/hfnet_tf/saved_models/hfnet"
    ...
    print(f'Total: {duration:.4f}, per image: {duration / len(imageNames):.4f}')
    # print("hello")